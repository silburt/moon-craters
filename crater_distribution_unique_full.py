...
if __name__ == '__main__':
    ...
    for i in range(len(datatypes)):
        ...
        for llt2,rt2 in thresholds:
            ...
            pred_crater_dist = extract_unique_pred(pred_crater_dist, lowilen_pred, lowilen_id, lowilen_P, llt2, rt2, pred_output_name)
