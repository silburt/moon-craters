...
CUDA_VISIBLE_DEVICES=1 nohup python get_crater_dist_HEAD.py > crater_dist_HEAD.txt &
...
CUDA_VISIBLE_DEVICES=1 nohup python moon_unet_s256_rings_dict.py > unet_s256_rings_dict_XEerr.txt &
