...
def FCN_skip_model(im_width,im_height,learn_rate,lmbda):
    ...
    a2 = Convolution2D(n_filters*2, FL_a, FL_a, activation='relu', name='conv2_a1', border_mode='same')(a1P)
    a2 = Convolution2D(n_filters*2, FL_a, FL_a, activation='relu', name='conv2_a2', border_mode='same')(a2)
    a2P = MaxPooling2D((2, 2), strides=(2, 2), name='pool2_a1')(a2)

    a3 = Convolution2D(n_filters*4, FL_a, FL_a, activation='relu', name='conv3_a1', border_mode='same')(a2P)
    a3 = Convolution2D(n_filters*4, FL_a, FL_a, activation='relu', name='conv3_a2', border_mode='same')(a3)
...
#    b1 = AtrousConvolution2D(n_filters, FL_b, FL_b, atrous_rate=(FDF,FDF), activation='relu', name='aconv1_b1', border_mode='same')(img_input)
...
#    b4 = AtrousConvolution2D(n_filters*8, FL_b, FL_b, atrous_rate=(FDF,FDF), activation='relu', name='aconv4_b2', border_mode='same')(b4)
    ...
    b1 = Convolution2D(n_filters, FL_b, FL_b, activation='relu', name='aconv1_b1', border_mode='same')(img_input)
    b1 = Convolution2D(n_filters, FL_b, FL_b, activation='relu', name='aconv1_b2', border_mode='same')(b1)
    b1P = MaxPooling2D((2, 2), strides=(2, 2), name='pool1_b1')(b1)

    b2 = Convolution2D(n_filters*2, FL_b, FL_b, activation='relu', name='aconv2_b1', border_mode='same')(b1P)
    b2 = Convolution2D(n_filters*2, FL_b, FL_b, activation='relu', name='aconv2_b2', border_mode='same')(b2)
    b2P = MaxPooling2D((2, 2), strides=(2, 2), name='pool2_b1')(b2)

    b3 = Convolution2D(n_filters*4, FL_b, FL_b, activation='relu', name='aconv3_b1', border_mode='same')(b2P)
    b3 = Convolution2D(n_filters*4, FL_b, FL_b, activation='relu', name='aconv3_b2', border_mode='same')(b3)
    b3P = MaxPooling2D((2, 2), strides=(3, 3), name='pool3_b1')(b3)

    b4 = AtrousConvolution2D(n_filters*8, FL_b, FL_b, activation='relu', name='aconv4_b1', border_mode='same')(b3P)
    b4 = AtrousConvolution2D(n_filters*8, FL_b, FL_b, activation='relu', name='aconv4_b2', border_mode='same')(b4)
