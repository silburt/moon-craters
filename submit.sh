...
CUDA_VISIBLE_DEVICES=1 nohup python moon_unet_s256_rings.py > unet_s256_rings_FLinitgridsearch.txt &
CUDA_VISIBLE_DEVICES=1 nohup python moon_unet_s256_rings_customloss.py > unet_s256_rings_customloss.txt &
