#This is one deeper than the standard rings model.
...
def unet_model(im_width,im_height,learn_rate,lmbda,FL):
    ...
    a4 = Convolution2D(n_filters*4, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv4_a1', border_mode='same')(a3P)
    a4 = Convolution2D(n_filters*4, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv4_a2', border_mode='same')(a4)
    a4P = MaxPooling2D((2, 2), strides=(2, 2), name='pool4_a1')(a4)

    u = Convolution2D(n_filters*8, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv5_a1', border_mode='same')(a4P)
    u = Convolution2D(n_filters*8, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv5_a2', border_mode='same')(u)

    u = UpSampling2D((2,2), name='up5->4')(u)
    u = merge((a4, u), mode='concat', name='merge4')
    u = Convolution2D(n_filters*4, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv_merge4_1', border_mode='same')(u)
    u = Convolution2D(n_filters*4, FL, FL, activation='relu', W_regularizer=l2(lmbda), name='conv_merge4_2', border_mode='same')(u)
