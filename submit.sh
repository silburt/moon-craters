...
CUDA_VISIBLE_DEVICES=0 nohup python moon_unet_s256_rings.py > unet_s256_rings_hardsig_inits.txt &
CUDA_VISIBLE_DEVICES=2 nohup python moon_unet_copied.py > unet_copied_upsamplecrossent.txt &
